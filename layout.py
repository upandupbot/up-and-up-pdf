...
sections = [
    ...
    # Channels and Elements
    {
        ...
        "fields": [
            ...
            {"label": "Select retail channel", "get": lambda f: f.get("select_retail_channel")},
            {"label": "Select retail element", "get": lambda f: f.get("select_retail_element")},
            {"label": "Print / POS element", "get": lambda f: f.get("print_pos_element")},
            {"label": "OOH element", "get": lambda f: f.get("ooh_element")},
            {"label": "Radio element", "get": lambda f: f.get("radio_element")},
            {"label": "Digital element", "get": lambda f: f.get("digital_element")},
            {"label": "TV element", "get": lambda f: f.get("tv_element")},
            {"label": "Staff uniforms element", "get": lambda f: f.get("staff_uniforms_element")},
            {"label": "Element regions", "get": lambda f: f.get("element_regions")},
            {"label": "Creative element specifications", "get": lambda f: f.get("creative_element_specifications")},
            {"label": "Creative element specifications attachment(s)", "get": lambda f: attachment_name(f.get("creative_element_specifications_attachment_s"))},
            {"label": "Creative element specifications free text / link(s)", "get": lambda f: f.get("creative_element_specifications_free_text_link_s")},
            ...
            {"label": "Branded elements", "get": lambda f: f.get("branded_channel_elements")},
            {"label": "Branded elements - Other", "get": lambda f: f.get("branded_elements_other")},
            {"label": "Branded Print/POS", "get": lambda f: f.get("branded_print_pos_2")},
            {"label": "Branded Print/POS - Other", "get": lambda f: f.get("other_branded_print_pos")},
            {"label": "Branded OOH", "get": lambda f: f.get("branded_ooh")},
            {"label": "Branded OOH - Other", "get": lambda f: f.get("branded_other_ooh")},
            {"label": "Branded Radio", "get": lambda f: f.get("branded_radio_2")},
            {"label": "Branded Radio - Other", "get": lambda f: f.get("branded_other_radio")},
            {"label": "Branded Digital", "get": lambda f: f.get("branded_digital_2")},
            {"label": "Branded Digital - Other", "get": lambda f: f.get("branded_other_digital")},
            {"label": "Branded TV", "get": lambda f: f.get("branded_tv")},
            {"label": "Branded TV - Other", "get": lambda f: f.get("branded_other_tv")},
            {"label": "Branded Staff uniforms", "get": lambda f: f.get("branded_staff_uniforms")},
            {"label": "Branded Staff uniforms - Other", "get": lambda f: f.get("branded_other_staff_uniforms")},
            {"label": "Branded elements summary", "get": lambda f: f.get("branded_elements_summary")},
            {"label": "Regions", "get": lambda f: f.get("regional_channels")},
            {"label": "Retailer elements", "get": lambda f: f.get("retailer_elements")},
            {"label": "Retailer elements - Other", "get": lambda f: f.get("other_retailer_elements_2")},
            {"label": "Retailer Print/POS", "get": lambda f: f.get("retailer_print_pos")},
            {"label": "Retailer Print/POS - Other", "get": lambda f: f.get("other_retailer_print_pos")},
            {"label": "Retailer OOH", "get": lambda f: f.get("retailer_ooh")},
            {"label": "Retailer OOH - Other", "get": lambda f: f.get("retailer_other_ooh")},
            {"label": "Retailer Radio", "get": lambda f: f.get("retailer_radio")},
            {"label": "Retailer Radio - Other", "get": lambda f: f.get("retailer_other_radio")},
            {"label": "Retailer Digital", "get": lambda f: f.get("retailer_digital")},
            {"label": "Retailer Digital - Other", "get": lambda f: f.get("retailer_other_digital")},
            {"label": "Retailer TV", "get": lambda f: f.get("retailer_tv")},
            {"label": "Retailer TV - Other", "get": lambda f: f.get("retailer_other_tv")},
            {"label": "Retailer elements summary", "get": lambda f: f.get("retailer_elements_summary")},
            {"label": "Informal elements", "get": lambda f: f.get("informal_channel_elements")},
            {"label": "Informal elements - Other", "get": lambda f: f.get("other_informal_channel_elements")},
            {"label": "Informal Print/POS", "get": lambda f: f.get("informal_print_pos")},
            {"label": "Informal OOH", "get": lambda f: f.get("informal_ooh")},
            {"label": "Informal Print/POS - Other", "get": lambda f: f.get("other_informal_print_pos")},
            {"label": "Informal Radio", "get": lambda f: f.get("informal_radio")},
            {"label": "Informal Radio - Other", "get": lambda f: f.get("informal_other_radio")},
            {"label": "Informal OOH - Other", "get": lambda f: f.get("informal_other_ooh")},
            {"label": "Informal Digital", "get": lambda f: f.get("informal_digital")},
            {"label": "Informal Digital - Other", "get": lambda f: f.get("informal_other_digital")},
            {"label": "Informal TV", "get": lambda f: f.get("informal_tv")},
            {"label": "Informal TV - Other", "get": lambda f: f.get("informal_other_tv")},
            {"label": "Informal Staff uniforms", "get": lambda f: f.get("informal_staff_uniforms")},
            {"label": "Informal Staff uniforms - Other", "get": lambda f: f.get("informal_other_staff_uniforms")},
            {"label": "Informal elements summary", "get": lambda f: f.get("informal_elements_summary")},
            {"label": "Regional elements", "get": lambda f: f.get("regional_channel_elements")},
            {"label": "Regional elements - Other", "get": lambda f: f.get("other_regional_elements")},
            {"label": "Regional Print / POS", "get": lambda f: f.get("regional_print_pos")},
            {"label": "Regional Print / POS - Other", "get": lambda f: f.get("other_regional_print_pos")},
            {"label": "Regional OOH", "get": lambda f: f.get("regional_ooh")},
            {"label": "Regional OOH - Other", "get": lambda f: f.get("regional_other_ooh")},
            {"label": "Regional Radio", "get": lambda f: f.get("regional_radio")},
            {"label": "Regional Radio - Other", "get": lambda f: f.get("regional_other_radio")},
            {"label": "Regional Digital", "get": lambda f: f.get("regional_digital")},
            {"label": "Regional Digital - Other", "get": lambda f: f.get("regional_other_digital")},
            {"label": "Regional Staff uniforms", "get": lambda f: f.get("regional_staff_uniforms")},
            {"label": "Regional staff uniforms - Other", "get": lambda f: f.get("regional_staff_uniforms_other")},
            {"label": "Regional elements summary", "get": lambda f: f.get("regional_elements_summary")},
            {"label": "Internal communications elements", "get": lambda f: f.get("internal_marketing_channels")},
            {"label": "Internal communications elements - Other", "get": lambda f: f.get("internal_marketing_elements_other")},
            {"label": "Direct Sales elements", "get": lambda f: f.get("direct_sales_elements")},
            {"label": "Direct Sales Digital", "get": lambda f: f.get("direct_sales_digital")},
            {"label": "Direct Sales Digital - Other", "get": lambda f: f.get("direct_sales_digital_other_field")},
            {"label": "Direct Sales Print/POS", "get": lambda f: f.get("direct_sales_print_pos")},
    ...
    # Production Brief Details
{
    ...
    # Deliverables
    {
        ...
        "fields": [
            ...
            {"id": "retail_strategy_deliverables", "label": "Retail strategy deliverables", "get": lambda f: f.get("retail_strategy_deliverables")},
            ...
            {"id": "retail_new_creative_concept_deliverables", "label": "Retail concept deliverables", "get": lambda f: f.get("retail_new_creative_concept_deliverables")},
            ...
            {"id": "retail_implementation_deliverables", "label": "Creative implementation deliverables", "get": lambda f: f.get("retail_implementation_deliverables")},
